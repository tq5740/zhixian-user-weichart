  ...
  <div class="complaint">
    ...
    <van-cell-group class="split">
      ...
      >
        ...
        <i
          class="iconfont hook-icon icon-gou"
          v-if="currentIndex===0"
        ></i>
    ...
    <div
      class="complaint-confirm-btn"
      @click.stop.prevent="onComplaintConfirmBtn"
    >确定投诉</div>
    <div
      class="complaint-success-container"
      v-if="showComplaintSuccessContainer"
    >
      ...
      <div
        class="complaint-success-confirm-btn"
        @click="onComplaintSuccessConfirmBtn"
      >确定</div>
    </div>
  ...
  methods: {
    ...
    onComplaintConfirmBtn() {
      ...
      const data = {
        ...
        url: url,
        complaintReason:
          this.complaintValueArr[currentIndex] + this.personalityLabelContent
      };
