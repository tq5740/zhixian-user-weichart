...
<template>
  <div class="login">
    ...
    <div class="pass_box">
      <input v-model="password" class="pass_box_info" type="password" placeholder="请输入新密码" maxlength="16">
    </div>

    <van-button size="large" class="btn" @click="editFunc" :loading="loading">修改</van-button>
...
export default {
  ...
  onLoad(){
    this.$store.commit("setTitle", "忘记密码");
  }
}
</script>
